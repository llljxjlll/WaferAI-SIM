    ...
    *, action: GlobalAction | None = None,
    ...
    mapping = {
        ...
        (RecordOpcode.NORM_GAMMA_WGRAD_TIMING, SemanticOperandId.COMPUTE_OUTPUT_ADDRESS):
            (BufferUseRole.COMP_OUTPUT, 0),
        (RecordOpcode.GEMM_WEIGHT_WGRAD_TIMING, SemanticOperandId.COMPUTE_INPUT_ADDRESS):
            (BufferUseRole.COMP_INPUT, 0),
        (RecordOpcode.GEMM_WEIGHT_WGRAD_TIMING, SemanticOperandId.COMPUTE_DATA_ADDRESS):
            (BufferUseRole.COMP_INPUT, 1),
