...
constexpr std::array<E, kOpcodeManifestSize> kManifest{{
    ...
    {Opcode::ROPE_QK_EXACT, "ROPE_QK_EXACT", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::ATTENTION_EXACT, "ATTENTION_EXACT",
     OpcodeVisibility::PUBLIC, OpcodeLifecycle::STABLE,
     OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::EMBEDDING_LOOKUP, "EMBEDDING_LOOKUP",
     OpcodeVisibility::PUBLIC, OpcodeLifecycle::STABLE,
     OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::GREEDY_SAMPLE, "GREEDY_SAMPLE", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::CROSS_ENTROPY_FORWARD, "CROSS_ENTROPY_FORWARD",
     OpcodeVisibility::PUBLIC, OpcodeLifecycle::STABLE,
     OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::CROSS_ENTROPY_BACKWARD, "CROSS_ENTROPY_BACKWARD",
     OpcodeVisibility::PUBLIC, OpcodeLifecycle::STABLE,
     OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    ...
    {Opcode::ADAMW_UPDATE, "ADAMW_UPDATE", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::SWIGLU_BACKWARD_TIMING, "SWIGLU_BACKWARD_TIMING",
     OpcodeVisibility::PUBLIC, OpcodeLifecycle::STABLE,
     OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::EMBEDDING_TABLE_WGRAD_TIMING,
     "EMBEDDING_TABLE_WGRAD_TIMING", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::NORM_GAMMA_WGRAD_TIMING,
    ...
    {Opcode::GEMM_DX_TIMING,
     "GEMM_DX_TIMING", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::MOE_SCORE_WEIGHTED_FORWARD,
     "MOE_SCORE_WEIGHTED_FORWARD", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::MOE_SCORE_WEIGHT_BACKWARD,
     "MOE_SCORE_WEIGHT_BACKWARD", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMPUTE},
    {Opcode::RMSNORM_BACKWARD_TIMING,
     "RMSNORM_BACKWARD_TIMING", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::ATTENTION_BACKWARD_TIMING,
     "ATTENTION_BACKWARD_TIMING", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::ROPE_BACKWARD_TIMING,
     "ROPE_BACKWARD_TIMING", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    {Opcode::RESIDUAL_BACKWARD_TIMING,
     "RESIDUAL_BACKWARD_TIMING", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE, OpcodeCategory::COMPUTE},
    ...
    {Opcode::REDUCE_COMPUTE, "REDUCE_COMPUTE", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMMUNICATION},
    {Opcode::LOCAL_REDUCE, "LOCAL_REDUCE", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMMUNICATION},
    {Opcode::LOCAL_NOC_SEND, "LOCAL_NOC_SEND", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMMUNICATION},
    {Opcode::LOCAL_NOC_RECV, "LOCAL_NOC_RECV", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMMUNICATION},
    {Opcode::LOCAL_NOC_WAIT, "LOCAL_NOC_WAIT", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::COMMUNICATION},
    ...
    {Opcode::SRAM_RENAME, "SRAM_RENAME", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::MEMORY},
    {Opcode::SRAM_ALLOC_AT, "SRAM_ALLOC_AT", OpcodeVisibility::PUBLIC,
     OpcodeLifecycle::STABLE, OpcodeSupport::AVAILABLE,
     OpcodeCategory::MEMORY},
